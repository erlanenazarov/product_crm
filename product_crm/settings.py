"""
Django settings for product_crm project.
...
SECRET_KEY = '8d43av3=0%1_k-i+xbm5^c9_8!88*2^s^&(4fv@$ss%bi-(!=y'
...
WSGI_APPLICATION = 'product_crm.wsgi.application'
